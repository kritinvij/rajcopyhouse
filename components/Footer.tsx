    ...
    <footer className="border-t border-slate-200 bg-slate-900 text-slate-300">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            <div className="mb-3 flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-amber-400 text-xs font-bold text-blue-950">
                RCH
              </div>
              <div>
            ...
            <p className="mb-1 text-sm text-slate-400">
              Complete Notebook Manufacturing Solutions
            </p>
        ...
        <div className="mt-10 border-t border-slate-700 pt-6 text-center text-xs text-slate-500">
          &copy; {new Date().getFullYear()} Raj Copy House. All rights
          reserved.
        </div>
      </div>
    </footer>
