  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 md:bottom-8 md:right-8">
      ...
      <a
        ...
        className="relative flex items-center gap-2 rounded-full bg-green-500 px-4 py-3 text-white shadow-lg transition-all hover:bg-green-600 hover:shadow-xl active:scale-95"
      >
        <WhatsAppIcon />
