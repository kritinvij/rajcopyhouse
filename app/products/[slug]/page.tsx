      ...
      <section className="bg-white px-4 py-10 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            ...
            <div>
              {product.brand && (
                <div className="mb-2 text-sm font-semibold uppercase tracking-wider text-amber-600">
                  {product.brand}
                </div>
              )}
                ...
                <table className="w-full text-sm">
                  <tbody>
                    {product.specs.map((spec, i) => (
                      ...
                      >
                        <td className="px-4 py-3 font-medium text-slate-700 w-2/5">
                          {spec.label}
                        </td>
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-amber-500 px-5 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-amber-600"
                >
                  <WhatsAppIcon />
                  Enquire on WhatsApp
                </a>
                <a
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-300 px-5 py-3.5 text-sm font-semibold text-slate-800 transition-colors hover:bg-slate-50"
                >
                  <PhoneIcon />
                  Call: +91 98100 35108
                </a>
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {related.map((rel) => (
                ...
                >
                  ...
                  <div className="p-4">
                    {rel.brand && (
                      <div className="mb-0.5 text-xs font-semibold uppercase tracking-wide text-amber-600">
                        {rel.brand}
                      </div>
                    )}
